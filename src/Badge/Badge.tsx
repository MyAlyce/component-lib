...
export type BadgeProps = { size: Size, badge?:  boolean | number, className?: HTMLAttributes<any>['className'] };
...
export const Badge = ({ size, badge, className }: BadgeProps) =>
    badge ? <div className={`bg-info-600 rounded-full absolute top-0 right-0 pl-1 pr-1 flex justify-center text-gray-100 ${badgeSize[size]} ${className}`}>
